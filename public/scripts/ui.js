...
const OnlineUsersPanel = (function() {
    ...
    return { initialize, update, addUser, removeUser, hide };
})();
...
const ChatPanel = (function() {
    ...
    const initialize = function() {
        ...
        $("#chat-input-form").on("keydown", (e) => {
            const currentUser = Authentication.getUser();
            Socket.typingMessage(currentUser);
        });
    ...
    const addMessage = function(message) {
        ...
        // if(message.requestedUser == currentUser){}
    ...
    const addTypingMessage = function(user) {
		
		const currentUser = Authentication.getUser();
		if(user.name == currentUser.name){
			return;
		}
		$("#typing-message").text(user.name + " is typing");
    ...
    return { initialize, update, addMessage, addTypingMessage };
})();
